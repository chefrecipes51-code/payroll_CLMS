...
makeDataTable("taxdeductionreport-list"); //Added By Harshida
makeDataTable("contractorpaymentreport-list"); //Added By Harshida
...
makeDataTable("compliancereport-list"); //Added By Harshida
...
makeDataTable("approval-listGrid"); //Added By Chirag
makeDataTable("SalaryStructure-list"); //Added By Chirag
